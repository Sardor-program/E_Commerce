...
class CartItem(models.Model):
    ...
    quanttity = models.ImageField(_("quantity"))
    ...
    def save(self, *args, **kwargs):
        self.subtotal = self.quanttity * self.product.price
...
class Card(models.Model):
    ...
    expity_date = models.DateField(_("Expration Date"))
...
class DeliveryTariff(models.Model):
    ...
    delivry_time = models.TimeField(_("Delivery Time"))
