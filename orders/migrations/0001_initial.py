    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expity_date', models.DateField(verbose_name='Expration Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quanttity', models.ImageField(upload_to='', verbose_name='quantity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivry_time', models.TimeField(verbose_name='Delivery Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('created', 'Created'), ('in_progress', 'In_progress'), ('delivered', 'Delivered'), ('cancelled', 'Cancelled'), ('finished', 'Finished')], max_length=60, verbose_name='Status')),
                ('total_price', models.FloatField(verbose_name='Total Price')),
                ('payment_status', models.CharField(choices=[('created', 'Crested'), ('pending', 'Pending'), ('paid', 'Paid'), ('cancelled', 'Cancelled')], max_length=60, verbose_name='Payment Status')),
