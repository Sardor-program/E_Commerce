...
from products.utilts import validate_rating
...
class Product(models.Model):
    ...
    quanttity = models.IntegerField(_("quanttity"))
    ...
    thumbunail = models.ForeignKey(Media, on_delete=models.SET_NULL, null=True, blank=True)
